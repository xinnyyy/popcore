...
import popcornBackground from "../assets/popcorn.jpeg";
...
const Register = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${popcornBackground})` }}
    >
      <Toaster />
      <div
        className="dark:bg-[#32353F] flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0"
      >
        <div
          className="w-[80%] md:w-full bg-white dark:bg-[#1E212A] border rounded-md px-6 py-4 mt-6 overflow-hidden shadow-md sm:max-w-md"
        >
          <form>
            <label
              className="mx-auto flex flex-col items-center justify-center w-32 h-32 rounded-full border-2 border-gray-300 border-dashed cursor-pointer bg-gray-50 hover:bg-gray-100 dark:text-white"
            >
